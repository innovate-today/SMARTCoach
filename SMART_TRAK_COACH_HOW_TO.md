...
9. Tap **Summary** when you need a quick group attendance view during practice. The summary loads synced attendance for the selected group and includes any marks currently saved on the phone. Use **Range** to review all dates, the last 7/14/30 days, or a custom date range. It shows the group attendance percentage plus each athlete's **%**, **P**, **A**, **E**, and **T** totals for the selected range. Use the athlete dropdown or tap an athlete row to focus on one athlete while discussing attendance; selecting one athlete also shows recent attendance marks by date, checkpoint, and status.
