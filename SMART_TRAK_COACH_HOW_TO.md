...
On track race screens, tap **Track Tools** for **Current Meet Results** and **Past Results**. Current Meet Results shows saved results from the open meet grouped by event, such as 100m, 200m, or 400m, so event results are not blended together. **Relay** stays in the tray as the direct relay timing control.
