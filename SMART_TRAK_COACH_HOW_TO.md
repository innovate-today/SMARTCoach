...
Use **Athlete Progression** to compare one athlete across like-for-like testing conditions. Choose the athlete, speed metric, surface, and timing method. SMART Trak shows the comparable best, latest session best, change from the first matching session, total reps, and a session history with average, range, fly zone, start type, and chronological New PB indicators.
