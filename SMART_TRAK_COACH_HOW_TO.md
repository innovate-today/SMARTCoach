...
Use **Share Miles Board** when you want a view-only mileage leaderboard for athletes. Set the Dashboard activity range first, then click **Share Miles Board**. SMART Trak creates a signed link that can be sent to athletes or parents. The board is read-only and sortable. It shows athlete name, groups, total miles, current-week miles, week change, workouts logged, average per workout, and last logged date. It also includes challenge highlights for mileage leader, this-week leader, consistency leader, and biggest positive week change, plus a Pack Challenge table for group totals. It does not show coach tools, notes, contact information, PB/SB details, or edit buttons.
