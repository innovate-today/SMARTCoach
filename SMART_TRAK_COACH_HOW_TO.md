...
4. Choose which details should appear: **Latest Meet**, **Season Results**, **Meet Archive**, **Athlete Summary**, **PB / SB Badges**, and **Team Summary**.
...
The public Results Board is read-only. It includes the latest meet for the selected sport/year, team totals, PB/SB totals, a Meet Archive with meet-by-meet result counts, an Athlete Summary with season totals by athlete, and a Season Results table that shows each athlete's best saved result by event. Viewers can filter by meet, event, gender, and search text without seeing coach tools or edit buttons.
