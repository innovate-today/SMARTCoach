...
To enter one result without a spreadsheet, click **Add Result**. Use **Edit** on a row to correct the athlete, metric, mark, date, grade, gender, stride count, or note. Use **Delete** only when a speed mark should be removed from Speed Trak.
