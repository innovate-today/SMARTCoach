...
Launch accounts through `/onboarding.html`: check system readiness, save the customer account setup, complete the live smoke test, copy the activation record, copy the coach invite, confirm phone follow-up, then copy the final activation record.
