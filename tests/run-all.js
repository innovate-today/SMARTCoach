...
function checkPowerTrakFeature() {
  ...
  [
    ...
    "function selectedRackRir(exercise)",
    "Choose reps in reserve before completing this rep.",
    "data-rack-rir",
    "targetRir:position.exercise.recordRir",
    "actualRir:actual.rir",
    "'Target RIR','Actual RIR'",
    'id="rackRepEditRir"',
    ...
    "Enter a valid actual result before completing this rep.",
    "Enter the result unit before completing this rep.",
    "if(!actual)return",
    'input[aria-invalid="true"]',
    "var rackRepSavePending=false",
    "if(rackRepSavePending)return",
    "rackRepSavePending?'Saving Rep...'",
    ...
    "'Prescribed Value','Actual Value','Unit','Target RIR','Actual RIR','Completed At'",
  ...
  [
    ...
    "prescribed rest countdown begins",
    ...
    "Use a rep's **Edit** control to open the saved-rep correction window",
    "Use **Edit Session** to open a correction window for the rack/session name and workout date",
    "**Export Results** downloads one CSV row per completed rep",
