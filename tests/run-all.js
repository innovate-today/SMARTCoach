...
function checkPowerTrakFeature() {
  ...
  [
    ...
    "power_provisional_",
    "Needs Roster Review",
    "provisionalAthletes:state.provisionalAthletes.concat(athlete)",
  ...
  ["power-trak-rack-v10", "/power-trak-rack.webmanifest", "/assets/smart-logo.png", "/power-trak-rack-queue.js", "/power-trak-rack-sync.js", "/power-trak-rack-shell", "url.pathname.startsWith(\"/api/\")"].forEach((text) => {
