...
function checkDashboardToolPreferences() {
  ...
  [
    ...
    "if(!dashboardSnapshotIsFresh(browserSnapshot))scheduleDashboardLiveRefresh(stamp,fetchOptions);",
    "if(!dashboardSnapshotIsFresh(result.data))scheduleDashboardLiveRefresh(stamp,fetchOptions);",
