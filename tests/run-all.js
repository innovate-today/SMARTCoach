...
function checkPartnerTimingPhaseOne() {
  ...
  [
    ...
    "picker-row partner-station-row",
    "class=\"picker-list\" style=\"padding:0;max-height:none\"",
    "ontouchstart=\"touchPartnerStation(event",
    "function touchPartnerStation(event,stationId)",
    "function clickPartnerStation(event,stationId)",
