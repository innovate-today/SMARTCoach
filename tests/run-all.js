...
function checkMobileWorkflowOpeningFlow() {
  ...
  [
    ...
    "if(dx>8||dy>8)WORKFLOW_TOUCH.moved=true;",
    "function openWorkflowFromRow(e,id)",
    "if(WORKFLOW_TOUCH.moved){if(e)e.preventDefault();return;}",
    'onpointerdown="workflowPointerDown(event)" onpointermove="workflowPointerMove(event)" onclick="openWorkflowFromRow(event,&quot;',
    "function chooseWorkflow(id)",
    "selectWorkflowForGroupChoice(id);",
    "go('s-groups');",
    "function openWorkflowAddMenu()",
    "openPicker('Add'",
    "onclick=\"choosePickerFromRow(event,",
    ...
    "onclick=\"openGroupFromRow(event,",
    ...
    "onclick=\"openTrainingModeFromRow(event,&quot;timer&quot;)",
    "onclick=\"openTrainingModeFromRow(event,&quot;speed&quot;)",
    "onclick=\"openTrainingModeFromRow(event,&quot;calendar&quot;)",
