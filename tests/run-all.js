...
function checkPowerTrakFeature() {
  ...
  [
    ...
    "Delete '+rack.rackName+' and all recorded athlete reps? This cannot be undone.",
  ...
  [
    ...
    "suggest common lifts plus exercise names already found",
