...
function checkStravaAdminTestFlow() {
  ...
  [
    ...
    "fetch('/api/smart-trak/strava-activity-detail?account='",
    "Strava API detail:",
    ...
    "returnPath='/training-calendar.html?account='",
  ...
  [
    ...
    '["/dashboard.html", "/training-calendar.html"].includes(url.pathname)',
