...
function checkDashboardWhatsNew() {
  ...
  [
    ...
    "Coaches can paste XC marks or upload a CSV file. Athletes do not need to be on the current roster, meet/year can be left blank, and 3200m cross country marks are shown with 2 Mile.",
