...
function checkPowerTrakFeature() {
  ...
  [
    ...
    "Each athlete appears once with their best result for the selected exercise.",
    "Completion-only exercises do not appear. Lower time ranks faster; load, height, and distance rank higher.",
    "function powerLeaderboardResults()",
    "function renderPowerLeaderboard()",
    "row.mode==='time'?row.value<current.value:row.value>current.value",
