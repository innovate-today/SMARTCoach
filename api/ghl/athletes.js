...
const ATHLETE_FIELD_ALIASES = {
  ...
  gender: ["gender", "athlete gender", "student gender", "runner gender", "sex", "division", "gender program", "program gender", "boy girl", "boys girls", "b/g", "male female", "gender identity"],
  grade: ["graduation year", "graduation_year", "grad year", "grad yr", "class year", "class_year", "class of", "school year", "year", "class", "grade"],
  parentGuardianName: ["parent_guardian_name", "parent guardian name", "parent/guardian name", "parent guardian 1 name", "parent/guardian 1 name", "guardian name", "guardian 1 name", "parent name", "parent 1 name", "primary parent name", "primary guardian name", "mother name", "mom name"],
  ...
  parentGuardian2Name: ["parent_guardian_2_name", "parent guardian 2 name", "parent/guardian 2 name", "guardian 2 name", "second parent name", "second guardian name", "parent 2 name", "other parent name", "other guardian name", "father name", "dad name"],
