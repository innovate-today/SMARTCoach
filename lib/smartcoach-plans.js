const PLAN_DEFINITIONS = {
  ...
  pro200: {
    ...
    monthlyAmount: "135.00",
    annualAmount: "1350.00",
    coachSeatLimit: 10,
    pro: true,
  },
  proUnlimited: {
...
function normalizeProductPlan(value) {
  ...
  if (raw === "pro unlimited" || raw === "smartcoach pro unlimited" || raw === "unlimited" || raw === "custom" || raw === "pro unlimited custom" || raw === "pro custom") return "proUnlimited";
