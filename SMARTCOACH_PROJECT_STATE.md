...
174. Updated SMARTCoach Pro Mobile App live field-event capture from single-athlete entry to a field-flight workflow. Coaches now select one field event, add multiple athletes to the flight, tap an athlete to record that athlete's attempts/best mark/wind/video/notes, and use **Save Flight Results** to queue all athletes in the flight before syncing through **Results**.
