...
- Automation and Stripe webhook responses now hide private integration token values in returned account records, while the protected internal registry lookup remains available for support verification.
