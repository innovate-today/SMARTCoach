...
437. Equipment Trak Setup rows can now be reordered with Up/Down controls. The saved row order is preserved and drives the Issue Sheet column order, so coaches can place uniforms, warmups, watches, chips, and bags in the order they want.
