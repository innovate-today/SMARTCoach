...
- Added **Copy Activation Record** to `/onboarding.html` so support can paste a customer setup summary with account key, plan, subscription, setup/access state, smoke-test progress, next action, and customer link.
